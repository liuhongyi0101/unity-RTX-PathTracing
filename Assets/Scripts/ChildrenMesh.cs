...
/// the scene manager.
/// </summary>
public class ChildrenMesh : MonoBehaviour
{
  ...
  /// the instance.
  /// </summary>
  private static ChildrenMesh s_Instance;

  /// <summary>
  /// get instance.
  /// </summary>
  public static ChildrenMesh Instance
  {
    get
    {
      if (s_Instance != null) return s_Instance;

      s_Instance = GameObject.FindObjectOfType<ChildrenMesh>();
      s_Instance?.Init();
      return s_Instance;
    }
  }
