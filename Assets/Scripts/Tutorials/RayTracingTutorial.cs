...
public abstract class RayTracingTutorial
{
  ...
  /// the tutorial asset.
  /// </summary>
  public RayTracingTutorialAsset _asset;
  ...
  protected Vector4 RequireOutputTargetSize(Camera camera)
  {
    ...
    private static void SetupCamera(ScriptableRenderContext context,Camera camera)
  {
        ...
        for (int i = 0; i < visibleLights.Length; i++)
        {
          ...
          //  {
          //      Shader.SetGlobalVector("_Sundir", visibleLight.light.transform.forward * -1.0f);
          //      Shader.SetGlobalVector("_Up", visibleLight.GetUp());
          //      Shader.SetGlobalVector("_Right", visibleLight.GetRight());
          //      Shader.SetGlobalVector("_Forward", visibleLight.GetForward());
          //  }
        }
