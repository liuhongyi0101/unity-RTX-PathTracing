...
public class RayTracingRenderPipeline : RenderPipeline
{
  ...
  {
        _asset = asset;
        RayTracingAccelerationStructure.RASSettings settings = new RayTracingAccelerationStructure.RASSettings(RayTracingAccelerationStructure.ManagementMode.Automatic, RayTracingAccelerationStructure.RayTracingModeMask.Everything, -1 ^ (1 << 9));
  ...
  private void BuildAccelerationStructure()
  {
    ...
    //ChildrenMesh.Instance.FillAccelerationStructure(ref _accelerationStructure);
